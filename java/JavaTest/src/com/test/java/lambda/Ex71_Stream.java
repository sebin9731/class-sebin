...
public class Ex71_Stream {
	...
	private static void m9() {
		...
		System.out.println(Data.getUserList().stream().max((a, b) -> a.getAge() - b.getAge()));
		...
		// 메서드의 반환값/인자값을 아무것도 안 주고 싶을 때..
		// - 값형은 사용 불가능(null을 대입 불가능해서)
		Optional<Integer> maxNum = nums2.stream()
						 .max((a, b) -> a - b);
		...
		System.out.println(Data.getIntList().stream()
											.mapToInt(num -> num)
											.average().getAsDouble());
