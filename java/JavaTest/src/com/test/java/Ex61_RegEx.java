...
public class Ex61_RegEx {
	...
	private static void m5() {
		...
		// 요구사항] 모든 길동이 찾기!!
		// - 성: 홍, 김, 박, 최, 이, 남궁, 남, 궁
		//String regex = "[홍길박최이남궁]{1,2}길동"; // X
		//String regex = "[홍길박최이(남궁)]{1,2}길동"; // X
		String regex = "(홍|길|박|최|이|남궁){1,2}길동";
...
//		System.out.println(txt);
		...
		String txt = """
				포켓몬 컴퍼니가 신작 ‘포켓몬 포코피아’hong@gmail.com의 사전예약을 15일부터 시작했다. 정식 발매일은 3월 5일이며, 닌텐도 스위치2 전용 타이틀이다.
				다운로드(DL) 버전은 ‘닌텐도 e숍’에서 예약 구매가 진행 중이고 패키지 버전 예약 접수도 이날부터 순차적으로 이뤄진다.
				포코피아는 메타몽이 인간의 모습으로 변신해 주인공으로 등장하는 포켓몬 스핀오프 작품이다.
				폐허가 된 마을을 배경으로 포켓몬들과 seb31@gmail.com교류하며 서식지를 꾸미는 방식으로 진행된다.
				파이리, 푸린, 라프라스 등 여러 세대의 포켓몬이 등장하며, 창백한 피카츄와 이끼투성이 잠만보 등 포코피아 전용 비주얼도 공개됐다.
				게임 내 시간은 현실과 연동되고 멀티플레이는 최대 4인까지 지원한다.
				""";
		// 이메일 추출하기
