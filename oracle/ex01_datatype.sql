    ...
    2. 문자형 > varchar2
        ...
        a. char
            ...
            - char(n): 최대 n자리 문자열, n(바이트)
                - 최소 크기: 1바이트
                - 최대 크기: 2000바이트
            - 데이터 삽입 후 > 남은 공간을 공백으로 채운다. > 항상 n자리로 만든다.(강박증)
            - 고정 문자열 > 전화번호, 우편번호, 이름(우리나라 한해서)
...
create table tblType (
    ...
    --num number(4,2) -- 4자리(정수 2자리 + 소수 이하 2자리), -99.99 ~ +99.99
...
insert into tblType (txt, txt2) values ('ABCDE', 'ABCDE');
