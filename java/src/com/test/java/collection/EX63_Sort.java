	...
	private static void m5() {
		...
		list.sort(new Comparator<Employee>() {
			...
			public int compare(Employee o1, Employee o2) {
				...
				//return o1.getDepartment().compareTo(o2.getDepartment()); // 부서 오름차순
				//return o1.getPosition().compareTo(o2.getPosition()); // 직위 오름차순
				
				//return o2.getPositionNumber() - o1.getPositionNumber();
...
//		});
	...
	private static void m3() {
		...
		//Arrays.sort(names);
		//Arrays.reverse(names); // 배열에는 reverse가 없음
	...
	private static void m2() {
		...
		// 내림차순
		//Collections.reverse(names); // 순서를 거꾸로 뒤집는 기능
		
		//System.out.println(names);
		
		
		// 내림차순 하는 방법(X) > 내가 원하는 모든 정렬을 하는 방법(O)
		// - Comparator 인터페이스
	...
	private static void m1() {
		...
		System.out.println(s1.compareTo(s2)); // 음수, 양수, 0
